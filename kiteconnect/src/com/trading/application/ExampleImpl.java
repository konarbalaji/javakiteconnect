...
public class ExampleImpl {
    ...
    public void getTriggerRange(KiteConnect kiteConnect, String[] instrument_exch_token) throws KiteException, IOException {
        ...
        System.out.println(triggerRangeMap.get("instrument_exch_token").lower);
        System.out.println(triggerRangeMap.get("instrument_exch_token").upper);
        System.out.println(triggerRangeMap.get("instrument_exch_token").percentage);
    }
    ...
    public void getQuote(KiteConnect kiteConnect,String[] instrument_exch_token) throws KiteException, IOException {
        ...
        System.out.println(quotes.get("instrumentToken >> " + instrument_exch_token).instrumentToken+"");
        System.out.println(quotes.get("oi >> " + instrument_exch_token).oi +"");
        System.out.println(quotes.get("volumeTradedToday >> " + instrument_exch_token).volumeTradedToday+"");
        System.out.println(quotes.get("lastTradedQuantity >> " + instrument_exch_token).lastTradedQuantity+"");
        System.out.println(quotes.get("lastTradedTime >> " + instrument_exch_token).lastTradedTime+"");
        System.out.println(quotes.get("change >> " + instrument_exch_token).change+"");
        System.out.println(quotes.get("sellQuantity >> " + instrument_exch_token).sellQuantity+"");
        System.out.println(quotes.get("lastPrice >> " + instrument_exch_token).lastPrice+"");
        System.out.println(quotes.get("buyQuantity >> " + instrument_exch_token).buyQuantity+"");
        System.out.println(quotes.get("ohlc >> " + instrument_exch_token).ohlc+"");
        System.out.println(quotes.get("timestamp >> " + instrument_exch_token).timestamp+"");
        System.out.println(quotes.get("averagePrice >> " + instrument_exch_token).averagePrice+"");
        System.out.println(quotes.get("oiDayHigh >> " + instrument_exch_token).oiDayHigh+"");
        System.out.println(quotes.get("oiDayLow >> " + instrument_exch_token).oiDayLow+"");
        System.out.println(quotes.get("depth.buy.get(4).getPrice() >> " + instrument_exch_token).depth.buy.get(4).getPrice());
        System.out.println(quotes.get("depth.buy.get(4).getQuantity() >> " + instrument_exch_token).depth.buy.get(4).getQuantity());
        System.out.println(quotes.get("depth.buy.get(4).getOrders() >> " + instrument_exch_token).depth.buy.get(4).getOrders());
        System.out.println(quotes.get("depth.sell.get(4).getPrice() >> " + instrument_exch_token).depth.sell.get(4).getPrice());
        System.out.println(quotes.get("depth.sell.get(4).getQuantity() >> " + instrument_exch_token).depth.sell.get(4).getQuantity());
        System.out.println(quotes.get("depth.sell.get(4).getOrders() >> " + instrument_exch_token).depth.sell.get(4).getOrders());
    ...
    public void getOHLC(KiteConnect kiteConnect, String[] instrument_exch_token) throws KiteException, IOException {
        ...
        System.out.println(kiteConnect.getOHLC(instrument_exch_token).get("instrument_exch_token").lastPrice);
        System.out.println(kiteConnect.getOHLC(instrument_exch_token).get("instrument_exch_token").ohlc.open);
        System.out.println(kiteConnect.getOHLC(instrument_exch_token).get("instrument_exch_token").ohlc.high);
        System.out.println(kiteConnect.getOHLC(instrument_exch_token).get("instrument_exch_token").ohlc.low);
        System.out.println(kiteConnect.getOHLC(instrument_exch_token).get("instrument_exch_token").ohlc.close);
    }

    /** Get last price for multiple instruments at once.
     * USers can either pass exchange with tradingsymbol or instrument token only. For example {NSE:NIFTY 50, BSE:SENSEX} or {256265, 265}*/
    public void getLTP(KiteConnect kiteConnect, String[] instrument_exch_token) throws KiteException, IOException {
        //String[] instruments = {"256265","BSE:INFY", "NSE:INFY", "NSE:NIFTY 50"};
        System.out.println(kiteConnect.getLTP(instrument_exch_token).get("instrument_exch_token").lastPrice);
    }
